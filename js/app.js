$(function(){
  ...
  function init() {
    ...
    sets.high_frequency_word_list = "a all and are at but can for have I in is it me my of on said the they to up we with you big come do down get go he like little no not one out see she so some that then this too was went what will an back be came day did dog eat from got had her here his into just look make mom now put there very when your am as away by cat dad going good has help home house how long made or over red saw them time tree two water where about been call could find first of its know many may more new only other part people take than these way were who work would after also any around before boy every follow give great live man much name old our right same say show small tell thing three want again another ask because change different does even hand kind land large men move must need off picture read such together try turn well why air always animal answer ask end found learn letter mean mother off page please point round should still think through under which world year".split(' ');
